  ...
  <form action="?page=signup&action=create-user" method="POST">
    ...
    <div class="form-floating mb-3">
      <input value="<?= $username ?? '' ?>" type="text" name="username"
        class="form-control <?= $usernameErr ? 'is-invalid' : '' ?>" id="floatingInput" placeholder="Username" required>
    ...
    <p class="text-center mt-3 mb-3 text-muted">Already Have an account? <a href="?page=login">Login</a></p>
  </form>
</main>
